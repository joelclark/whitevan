...
use App\Http\Controllers\Sysops\DepositController;
...
Route::middleware(['auth', 'verified', 'sysop'])->prefix('sysops')->group(function () {
    ...
    Route::get('/deposits', [DepositController::class, 'edit'])->name('sysops.deposits.edit');
    Route::put('/deposits', [DepositController::class, 'update'])->name('sysops.deposits.update');
